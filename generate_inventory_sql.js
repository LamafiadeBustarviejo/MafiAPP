...
const rawData = `Objeto	Descripción	Ubicación
...
const rows = lines.slice(1).map(line => {
    ...
    return `('${safeName}', '${safeDesc}', '${safeLoc}')`;
});

const sql = `-- IMPORTACIÓN MASIVA DE INVENTARIO
...
fs.writeFileSync('c:/Users/soyel/Downloads/MafiAPP/import_inventory.sql', sql);
console.log('Script SQL de inventario generado!');
